...
class NoteFile private constructor(
    ...
    companion object {
        ...
        fun parse(raw: String): NoteFile {
            ...
            if (!raw.startsWith("---\n")) return NoteFile(frontMatterRaw = null, body = raw)
            ...
            return NoteFile(frontMatterRaw = frontMatterRaw, body = body)
        }
    ...
    fun ensureId(): NoteFile {
        ...
        return NoteFile(frontMatterRaw = updateRaw, body = body)
    }

    fun withBody(body: String): NoteFile = NoteFile(frontMatterRaw = frontMatterRaw ?: generatedId(), body = body)
